...
assert.deepEqual(await page.$$eval(".shelf-heading",xs=>Object.fromEntries(xs.map(x=>[x.querySelector("h2").textContent,Number(x.querySelector("span").textContent)]))),expected);
