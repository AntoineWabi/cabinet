...
const expected={"Want to read":14,"Classics ladder":27,"Author paths":51,"One-off picks":1,"Library":7};
...
assert.deepEqual(await page.$$eval(".grid-shelf > header",xs=>Object.fromEntries(xs.map(x=>[x.querySelector("h2").textContent,Number(x.querySelector("span").textContent)]))),expected);
